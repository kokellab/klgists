...
from klgists.bioinf.uniprot_go_terms import UniProtGoTerms
...
class GoTermsAtLevel:
	...
	def go_term_ancestors_for_uniprot_id_as_df(self, uniprot_id: str, level: int, kinds_allowed: List[str] = ['P', 'F', 'C']) -> pd.DataFrame:
